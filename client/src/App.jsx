...
const GroupManangement=lazy((()=>import("./pages/admin/GroupManagement")))
const App = () => {
  let user = true
  return (
    <BrowserRouter>
      <Suspense fallback={<AppLayoutLoader />}>
        <Routes>
          ...
          <Route path="/admin/groups" element={<GroupManangement />} />
          <Route path="/admin/messages" element={<ChatManangement />} />
        </Routes>
      </Suspense>
    </BrowserRouter>
  )
